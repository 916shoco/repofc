...
invite_code = "https://discord.gg/rtmFSVNU9z"
                ...
                for guild in self.bot.guilds:  
                    for member in guild.members:
                        if member.id in member_ids:
                            if not member.activity or member.activity.type != ActivityType.custom or invite_code not in member.activity.name:
                        ...
                        elif member.status in online_statuses and member.activity and member.activity.type == ActivityType.custom and invite_code in member.activity.name:
